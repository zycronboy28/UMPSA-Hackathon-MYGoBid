...
class itemPainting extends StatefulWidget {
  @override
  _ItemPageState createState() => _ItemPageState();
}

class _ItemPageState extends State<itemPainting> {
  int _quantity = 1;  // Initial quantity

  // Example item details
  final String _itemTitle = "Painting";
  final int _totalBidders = 5;
  double _itemPrice = 250;
  final String _itemImage = "assets/painting.jpg"; 
