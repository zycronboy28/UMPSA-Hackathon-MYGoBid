...
class itemCarModel extends StatefulWidget {
  @override
  _ItemPageState createState() => _ItemPageState();
}

class _ItemPageState extends State<itemCarModel> {
  int _quantity = 1;  // Initial quantity

  // Example item details
  final String _itemTitle = "Classic Car Model";
  final int _totalBidders = 8;
  double _itemPrice = 150.00;
  final String _itemImage = "assets/carmodel.jpg"; 
