...
class itemVase extends StatefulWidget {
  @override
  _ItemPageState createState() => _ItemPageState();
}

class _ItemPageState extends State<itemVase> {
  int _quantity = 1;  // Initial quantity

  // Example item details
  final String _itemTitle = "Antique vase";
  final int _totalBidders = 12;
  double _itemPrice = 150.00;
  final String _itemImage = "assets/vase.jpg"; 
