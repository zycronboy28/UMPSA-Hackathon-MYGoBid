...
class itemVintageWatch extends StatefulWidget {
  @override
  _ItemPageState createState() => _ItemPageState();
}

class _ItemPageState extends State<itemVintageWatch> {
  int _quantity = 1;  // Initial quantity

  // Example item details
  final String _itemTitle = "Vintage Watch";
  final int _totalBidders = 128;
  double _itemPrice = 320.00;
  final String _itemImage = "assets/vintagewatch.jpg"; 
